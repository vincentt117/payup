...
public class OcrProcess extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request1, HttpServletResponse response1) throws ServletException, IOException {
		...
		response1.getWriter().append("Served at: ").append("nothing");
	...
	private ArrayList<String> doStuff(FileItem fileItem) throws IOException{
		...
		//byte[] data = IOUtils.toByteArray(servletContext.getResourceAsStream("WEB-INF/receipt.jpg"));
		//byte[] data = org.apache.commons.io.IOUtils.toByteArray(servletContext.getResourceAsStream("WEB-INF/receipt.jpg"));
